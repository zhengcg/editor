...
<div class="login">
      ...
      <div class="formBox">
        <div class="inputBox">
          <el-input placeholder="请输入手机号" v-model="telPhone" class="input-with-select" maxlength="11"  @keyup.enter.native="doReset">
        ...
        <div class="inputBox" v-if="isShowCode">
          <el-input placeholder="请输入验证码" v-model="tuCode" class="input-with-select"  @keyup.enter.native="doReset">
            <el-button slot="append" @click="changeCode"><img :src="codeUrl" alt=""></el-button>
          </el-input>
        </div>
        <div class="inputBox">
          <el-input placeholder="请输入短信验证码" v-model="yanCode" class="input-with-select"  @keyup.enter.native="doReset">
        ...
        <div class="inputBox">
          <el-input
            ...
            v-model="password" type="password"  @keyup.enter.native="doReset"
            clearable>
          </el-input>
        </div>
        <!-- <div class="inputBox">
        ...
        <div class="inputBox" style="margin-top: 20px;">
          <el-button type="primary" style="width:360px;" @click="doReset">提交</el-button>
        </div>
        <div class="inputBox">
  ...
  methods:{
    ...
    // 手机号验证
     ...
     getCode:function(){
      ...
      // self.axios.get(api.getCode,{params:{method:"resetPsd",deviceId:self.sjs}}).then(function (res) {
      ...
      // 　　
      // });
      self.codeUrl='http://smart.mingmai.com/pro/validateCode?method=resetPsd&deviceId='+self.sjs
     ...
     sendCode:function(){
      ...
      if(self.isPoneAvailable(self.telPhone)){
        ...
        self.axios({
          method: 'post',
          url:api.sendCodeF,
          params:{mobile:self.telPhone,validateCode:self.tuCode,method:"resetPsd",deviceId:self.sjs}         
        }).then(function (res) {
            if(res.data.code==200){
             loading.close();
             self.countDown()
